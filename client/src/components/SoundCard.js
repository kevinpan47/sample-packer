...
const SoundCard = (props) => {
  return (
    <div className="bg-gray-100 shadow overflow-hidden sm:rounded-lg border-2">
      <div className="flex items-start py-4 rounded sm:px-4 lg:flex-row sm:hover:translate-x-4 sm:hover:bg-blue-gray-50">
        <table className="table-auto w-full sm:flex-col">
          ...
          <tbody className="text-s divide-y divide-gray-100">
            <tr>
              <td className="p-2 whitespace-wrap w-4/12">
                <div className="flex items-center">
                  <div className="font-bold text-gray-800">{props.sound.name}</div>
                </div>
              </td>
              <td className="p-2 whitespace-nowrap w-1/12 items-center mx-auto">
              ...
              <td className="p-2 whitespace-nowrap w-1/12">
              ...
              <td className="p-2 whitespace-nowrap content-center w-3/12">
                <img className="rounded-lg mx-auto" src={props.sound.image}/>
              </td>
              <td className="p-2 whitespace-nowrap w-2/12">
                <audio
                  className="mx-auto"
                  controls
                >
        ...
        <div className="text-sm flex w-40 pl-4">
          <table className="mx-auto">
            ...
            <br/>
            <tr>
              <button className="w-full bg-red-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
